...
public class App {
    public static void main(String[] args) {
        ...
        try {
            ...
            JDOMCrontroller controller = JDOMCrontroller.getInstance(INPUT_RSS);
            controller.loadData();
            ...
            System.out.println("-- Se obtienen todos los títulos --");
            controller.getAllTitle().forEach(System.out::println);
            System.out.println("-- Se obtienen todas las imágenes --");
            controller.getAllImages().forEach(System.out::println);
            System.out.println("-- Se obtiene el 5º elemento título --");
            System.out.println(controller.getFirstTitle(5));
